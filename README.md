...
- Metered PumpPortal token trades pass through the always-running service in `relay/`, with a protected server-to-server SSE proxy and an in-process fallback; the funded API key is never sent to browsers
